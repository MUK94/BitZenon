                        ...
                        <table class="min-w-full bg-white rounded-lg">
                            <thead class="bg-gray-800 text-white">
                                <tr>
                                    ...
                                    <th class="py-2  text-white">Title</th>
                                    <th class="py-2  text-white">Edit</th>
                                    <th class="py-2  text-white">Delete</th>
                                </tr>
                            </thead>
                            <tbody>
                                @if ($articles->count() > 0)
                                    @foreach ($articles as $article)
                                        <tr>
                                            ...
                                            <td class="border px-4 py-2">
                                                <a href="{{ route('articles.edit', $article) }}"><i
                                                        class="fa-regular fa-pen-to-square text-green-500"></i></a>
                                            </td>
                                            <td class="border px-4 py-2">
                                                <form action="{{ route('articles.destroy', $article) }}" method="POST">
                                                    ...
                                                    <button type="submit"><i
                                                            class="text-red-600 fa-solid fa-trash"></i></button>
                                                </form>
                                            </td>
                                        </tr>
                                    @endforeach
