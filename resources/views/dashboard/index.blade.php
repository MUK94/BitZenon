...
@section('content')
    <div class="dashboard-container">
        ...
        <div class="admin-sidebar">
            <nav class="admin-nav">
                <ul class="pages mb-8">
                    <span class="text-gray-400 my-2 pb-2">Menu</span>
                ...
                <ul class="others my-4">
                    <span class="text-gray-400 my-2 pb-2">Others</span>
                    <li class="text-white px-3 py-3">
                        <a href="#" class="flex">
                            <svg xmlns="http://www.w3.org/2000/svg" class="fill-sidebar-svg mr-2" viewBox="0 0 640 512">
                                <path
                    ...
                    <li class="text-white px-3 py-3">
                        <a href="#" class="flex">
                            <svg xmlns="http://www.w3.org/2000/svg" class="fill-sidebar-svg mr-2" viewBox="0 0 448 512">
                                <path
        ...
        {{-- Content --}}
        <div class="py-8 px-1 admin-content">
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
                        ...
                        <div
                            ...
                            <div class="mt-4 flex items-end justify-between">
                                ...
                                <span class="flex items-center gap-1 text-sm font-medium text-meta-3">
                                    10%
                                    <svg class="fill-arrow" width="10" height="11" viewBox="0 0 10 11"
