<div class="services-wrapper">
    {{-- Services --}}
    <div class="service-cards flex lg:flex-row flex-col lg:justify-center items-center p-2 bg-slate-100 min-h-screen">
        <div
            ...
            <div class="mt-auto w-full">
                ...
                <div class="text-xs mt-3 text-slate-600 line-height-2">
                    Every detail counts, you think it, We Web it for you.</div>
            </div>
        </div>
        <div
            class="lg:w-[26rem] w-full lg:my-0 text-white my-4 border-2 border-gray-200 p-5 rounded-2xl lg:shadow-8 middle-card">
            <div class="pb-3 mb-5 border-b border-gray-200">
                <div class="text-xs text-gray-400 mb-2">ENTREPRISE</div>
                <div class="flex items-center">
                    <h2 class="text-3xl m-0 text-white ">Business Apps & Process Automation</h2>
                </div>
            </div>
            ...
            <div class="mt-auto w-full">
                <button
                    class="bg-teal-500 rounded-xl cursor-pointe  py-2 border-none w-full flex items-center justify-between px-3">
                    Get Quote
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                        <path
                            d="M438.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L338.8 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l306.7 0L233.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160z" />
        ...
        <div
            ...
            <div class="pb-3 mb-5 border-b border-gray-200">
                ...
                <div class="flex items-center">
                    <h2 class="text-3xl m-0 custom-blue-color-1 ">Data Analytics & Visualization</h2>
                </div>
            </div>
            <div class="flex items-center mb-2">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
            ...
            <div class="mt-auto w-full">
                ...
                <div class="text-xs mt-3 text-gray-500 line-height-2">
                    Power BI and Microsoft Fabric for a data-driven business
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="testimonials my-4">
        <section class="bg-gray-100 p-4 rounded-lg">
            <div class="mx-auto max-w-[1340px] px-4 py-6 sm:px-6 lg:me-0 lg:py-16 lg:pe-0 lg:ps-8 xl:py-24">
                <div class="max-w-7xl items-center justify-between sm:flex sm:pe-6 lg:pe-8">
                    <h2 class="tracking-tight text-4xl text-black">
