<div class="services-wrapper">
    <div class="service-cards flex lg:flex-row flex-col lg:justify-center items-center bg-slate-100 min-h-screen">
        <div class=" bg-white w-full border-2 lg:border-r-0 border-gray-200 p-5 rounded-2xl lg:rounded-r-none side-card">
        ...
        <div
            class=" bg-white w-full border-2 lg:border-l-0 border-gray-200 p-5 rounded-2xl lg:rounded-l-none side-card">
            <div class="pb-3 mb-5 border-b border-gray-200">
