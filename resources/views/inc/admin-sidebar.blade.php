    ...
    <nav class="admin-nav ">
        <ul class="pages mb-4">
            ...
            <li class="text-white px-3 py-3">
                <a href="/admin/articles/" class="flex">
            ...
            <li class="text-white px-3 py-3">
                <a href="/admin/categories/" class="flex">
                    <svg xmlns="http://www.w3.org/2000/svg" class="fill-sidebar-svg mr-2" viewBox="0 0 512 512">
                        <path
            ...
            <li class="text-white px-3 py-3">
                <a href="/admin/podcasts/" class="flex">
            ...
            <li class="text-white px-3 py-3">
                <a href="/admin/topics/" class="flex">
						<svg xmlns="http://www.w3.org/2000/svg" class="fill-sidebar-svg mr-2" viewBox="0 0 512 512">
							<path d="M0 96C0 60.7 28.7 32 64 32l384 0c35.3 0 64 28.7 64 64l0 320c0 35.3-28.7 64-64 64L64 480c-35.3 0-64-28.7-64-64L0 96zm64 0l0 64 64 0 0-64L64 96zm384 0L192 96l0 64 256 0 0-64zM64 224l0 64 64 0 0-64-64 0zm384 0l-256 0 0 64 256 0 0-64zM64 352l0 64 64 0 0-64-64 0zm384 0l-256 0 0 64 256 0 0-64z"/></svg>
                    Topics
                </a>
            </li>
            ...
            <li class="text-white px-3 py-3">
                <a href="/admin/hero-section/" class="flex">
                    <svg xmlns="http://www.w3.org/2000/svg" class="fill-sidebar-svg mr-2" viewBox="0 0 384 512">
                        <path
            ...
            <li class="text-white px-3 py-3">
                <a href="/admin/about-section/" class="flex">
            ...
            <li class="text-white px-3 py-3">
                <a href="/admin/testimonials/" class="flex">
                    <svg xmlns="http://www.w3.org/2000/svg" class="fill-sidebar-svg mr-2" viewBox="0 0 512 512">
                        <path
        ...
        <ul class="others my-4 ">
            ...
            <li class="text-white px-3 py-3">
                <a href="/admin/profile/" class="flex">
            ...
            <li class="text-white px-3 py-3">
                <a href="/admin/messages/" class="flex">
                    <svg xmlns="http://www.w3.org/2000/svg" class="fill-sidebar-svg mr-2" viewBox="0 0 512 512">
                        <path
            ...
            <li class="text-white px-3 py-3">
                <a href="/admin/comments/" class="flex">
                    <svg xmlns="http://www.w3.org/2000/svg" class="fill-sidebar-svg mr-2" viewBox="0 0 640 512">
                        <path
