<section>
    <div>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __("Update Profile Info and your account email address") }}
        </p>
			</div>
    ...
    <form method="post" action="{{ route('admin.profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="email" name="email" type="email"
				class="px-2 mt-1 block w-full border border-solid h-10 focus:outline-none focus:border-2 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500 rounded-md shadow-sm" :value="old('email', $user->email)" required autocomplete="username" />
